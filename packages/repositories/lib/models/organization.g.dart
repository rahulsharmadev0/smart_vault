...
_DocumentFile _$DocumentFileFromJson(Map<String, dynamic> json) => _DocumentFile(
  orgId: json['orgId'] as String,
  ...
  uploadedAt:
      json['uploadedAt'] == null ? null : DateTime.parse(json['uploadedAt'] as String),
  updatedAt:
      json['updatedAt'] == null ? null : DateTime.parse(json['updatedAt'] as String),
  attributes: json['attributes'] as Map<String, dynamic>? ?? const {},
);

Map<String, dynamic> _$DocumentFileToJson(_DocumentFile instance) => <String, dynamic>{
...
Map<String, dynamic> _$BucketToJson(_Bucket instance) => <String, dynamic>{
  ...
  'description': instance.description,
  'fileTypes': instance.fileTypes.map((e) => _$DocumentTypeEnumMap[e]!).toList(),
  'attributes': instance.attributes,
};

TextAttribute _$TextAttributeFromJson(Map<String, dynamic> json) => TextAttribute(
  label: json['label'] as String,
  attributeId: json['attributeId'] as String?,
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic> _$TextAttributeToJson(TextAttribute instance) => <String, dynamic>{
...
SingleSelectAttribute _$SingleSelectAttributeFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$SingleSelectAttributeToJson(SingleSelectAttribute instance) =>
    <String, dynamic>{
      'attributeId': instance.attributeId,
      'label': instance.label,
...
MultiSelectAttribute _$MultiSelectAttributeFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$MultiSelectAttributeToJson(MultiSelectAttribute instance) =>
    <String, dynamic>{
      'attributeId': instance.attributeId,
      'label': instance.label,
      'options': instance.options,
